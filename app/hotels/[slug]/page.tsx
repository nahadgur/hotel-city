        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-16 max-w-5xl">
          <div>
            <div className="eyebrow mb-4">
              {hotel.region === 'london' ? 'Other grand London hotels' : hotel.region === 'cotswolds' ? 'Other Cotswolds hotels' : hotel.region === 'scotland' ? 'Other Scotland hotels' : 'Other hotels we cover'}
            </div>
            ...
            <ul className="space-y-2.5 text-sm">
              ...
              <li>
                <Link href={`/guide/${hotel.region}/`} className="text-ink-900 link-underline">
                  All {hotel.region === 'london' ? 'London' : hotel.region === 'cotswolds' ? 'Cotswolds' : hotel.region === 'scotland' ? 'Scotland' : ''} hotels we cover
                </Link>
              </li>
            </ul>
          </div>
